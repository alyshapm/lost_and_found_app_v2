...
from db import notifsCollection, usersCollection
import os 
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <td align="center" bgcolor="#ffffff" style="padding: 12px;">
                                    ...
                                    <tr>
                                        ...
                                        <a href="http://localhost:5173/" target="_blank" style="display: inline-block; padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">{btn_txt}</a>
                                        </td>
                                    </tr>
                                    </table>
                                </td>
...
class NotificationsCrud:
    ...
    async def send_notification(notification : Notifications):
    
        await notifsCollection.insert_one(notification.dict())

        user = await usersCollection.find_one({"_id": ObjectId(notification.user_id)})
        if not user or not user.get("email"):
            raise HTTPException(status_code=404, detail="User email not found.")
        
        send_email(user["personal_info"]["email"],notification.title,notification.message)
